...
class FLOPsCalculator:
    ...
    def calculate_attention(self, batch_size: int, sequence_length: int, hidden_dimensions: int) -> int:
        """
    ...
    def calculate_feedforward(self, batch_size: int, sequence_length: int, 
    ...
    def calculate_prefill(self, batch_size: int, sequence_length: int, 
        ...
        flops_attention = self.calculate_attention(batch_size, sequence_length, hidden_dimensions)
        flops_feedforward = self.calculate_feedforward(batch_size, sequence_length, hidden_dimensions, feedforward_dimensions)
    ...
    def calculate_flops_per_token(self, batch_size: int, hidden_dimensions: int, 
        ...
        flops_feedforward = self.calculate_feedforward(batch_size, 1, hidden_dimensions, feedforward_dimensions)
