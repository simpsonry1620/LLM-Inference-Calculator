...
def calculate_metrics(results: dict) -> dict:
    ...
    total_request_time = results["calculator_results"]["performance"][
        "total_request_time"
    ]
    ...
    return {"calc_req_s_gpu": calc_req_s_gpu, "calc_gpus_for_10": calc_gpus_for_10}
...
def convert_results_to_csv():
    ...
    try:
        ...
        print(
            "Please run the simulation script first (scripts/run_benchmark_simulations.py)"
        )
        return
